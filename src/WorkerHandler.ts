...
const ensureWebWorker = () => {
  ...
  if (
    ...
    (typeof Worker !== 'object' ||
      typeof (Worker as { prototype: Worker }).prototype.constructor !==
        'function')
  ) {
...
const setupWorker = (script, options) => {
...
const setupBrowserWorker = (script, Worker) => {
